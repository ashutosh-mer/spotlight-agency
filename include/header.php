            ...
            <div class="content">
                ...
                <div class="full-menu">
                    <div class="full-menu-left">
                        <div class="icon">
                            <svg viewBox="0 0 108 150" fill="currentColor">
                                <path
                        ...
                        <div class="full-menu-left-content">
                            <div class="desc">
                                <p>Do you have a project in mind you would like to talk about with us?</p>
                            </div> <a href="contactus.php" class="btn btn-primary">
                                Get in touch
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="full-menu-right">
                        ...
                        <div class="contact-info">
                            ...
                            <div class="right">
                                <div class="group">
                                    <div class="contact-title">Social Media
                                    </div>
                                ...
                                <div class="group">
                                    <div class="contact-title">Appendix
                                    </div>
